...
class Cliente:
    ...
    Um cliente pode possuir uma ou mais contas e realizar transações.
    """
...
class Conta:
    ...
    def nova_conta(cls, cliente, numero):
        """Factory method para criação de contas."""
...
class ContaCorrente(Conta):
    """
    Conta corrente com limite de saque e quantidade máxima de saques.
    """
    ...
    def sacar(self, valor):
        """Aplica regras específicas de saque da conta corrente."""
        numero_saques = len(
...
class Historico:
    ...
    def adicionar_transacao(self, transacao):
        """Registra uma transação com data e valor."""
...
class Transacao(ABC):
    """
    Interface base para transações bancárias.
    """
...
def recuperar_conta_cliente(cliente):
    ...
    FIXME: versão simplificada — não permite escolha de múltiplas contas.
    """
...
def main():
    ...
    Controla o fluxo do menu e as operações.
    """
    clientes = []
    contas = []
